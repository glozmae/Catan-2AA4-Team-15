...
public abstract class Player {
    ...
    private int roadLengthCalc(Node n, Set<Road> visitedRoads) {
        if (n.getPlayer() != null && n.getPlayer() != this) {
            return 0;
        }
        ...
        // Check Left
        if (n.getLeftRoad() != null
                && n.getLeftRoad().getOwner() == this
                && !visitedRoads.contains(n.getLeftRoad())) {
        ...
        // Check Right
        if (n.getRightRoad() != null
                && n.getRightRoad().getOwner() == this
                && !visitedRoads.contains(n.getRightRoad())) {
            Set<Road> newVisited = new HashSet<>(visitedRoads);
        ...
        // Check Vertical
        if (n.getVertRoad() != null
                && n.getVertRoad().getOwner() == this
                && !visitedRoads.contains(n.getVertRoad())) {
            Set<Road> newVisited = new HashSet<>(visitedRoads);
